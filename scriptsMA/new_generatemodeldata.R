...
t2mERA5_1<- brick(x = 'dataMA/19892000ERA5wateriso-002.nc',
                  varname="t2m")
t2mERA5_2<- brick(x= "dataMA/20012009ERA5wateriso-004.nc",
                  varname="t2m")
t2mERA5_3<- brick(x = 'dataMA/20102019ERA5wateriso-003.nc',
                  varname="t2m")
...
swvl1ERA5_1<- brick(x = 'dataMA/19892000ERA5wateriso-002.nc',
                    varname="swvl1")
swvl1ERA5_2<- brick(x = 'dataMA/20012009ERA5wateriso-004.nc',
                    varname="swvl1")
swvl1ERA5_3<- brick(x = 'dataMA/20102019ERA5wateriso-003.nc',
                    varname="swvl1")
...
swvl2ERA5_1<- brick(x = 'dataMA/19892000ERA5wateriso-002.nc',
                    varname="swvl2")
swvl2ERA5_2<- brick(x = 'dataMA/20012009ERA5wateriso-004.nc',
                    varname="swvl2")
swvl2ERA5_3<- brick(x = 'dataMA/20102019ERA5wateriso-003.nc',
                    varname="swvl2")
...
swvl3ERA5_1<- brick(x = 'dataMA/19892000ERA5wateriso-002.nc',
                    varname="swvl3")
swvl3ERA5_2<- brick(x = 'dataMA/20012009ERA5wateriso-004.nc',
                    varname="swvl3")
swvl3ERA5_3<- brick(x = 'dataMA/20102019ERA5wateriso-003.nc',
                    varname="swvl3")
...
swvl4ERA5_1<- brick(x = 'dataMA/19892000ERA5wateriso-002.nc',
                    varname="swvl4")
swvl4ERA5_2<- brick(x = 'dataMA/20012009ERA5wateriso-004.nc',
                    varname="swvl4")
swvl4ERA5_3<- brick(x = 'dataMA/20102019ERA5wateriso-003.nc',
                    varname="swvl4")
...
ERA5$int_smwl<-((0.07*1000*(ERA5$smwl1))+(0.21*1000*(ERA5$smwl2))+
                  (0.72*1000*(ERA5$smwl3))+(1.89*1000*(ERA5$smwl4)))

lai_lvERA5_1<- brick(x = 'dataMA/19892000ERA5wateriso-002.nc',
                    varname="lai_lv")
lai_lvERA5_2<- brick(x = 'dataMA/20012009ERA5wateriso-004.nc',
                    varname="lai_lv")
lai_lvERA5_3<- brick(x = 'dataMA/20102019ERA5wateriso-003.nc',
                    varname="lai_lv")
...
lai_hvERA5_1<- brick(x = 'dataMA/19892000ERA5wateriso-002.nc',
                     varname="lai_hv")
lai_hvERA5_2<- brick(x = 'dataMA/20012009ERA5wateriso-004.nc',
                     varname="lai_hv")
lai_hvERA5_3<- brick(x = 'dataMA/20102019ERA5wateriso-003.nc',
                     varname="lai_hv")
...
mperERA5_1<- brick(x = 'dataMA/19892000ERA5wateriso-002.nc',
                     varname="mper")
mperERA5_2<- brick(x = 'dataMA/20012009ERA5wateriso-004.nc',
                     varname="mper")
mperERA5_3<- brick(x = 'dataMA/20102019ERA5wateriso-003.nc',
                     varname="mper")
...
mtprERA5_1<- brick(x = 'dataMA/19892000ERA5wateriso-002.nc',
                   varname="mtpr")
mtprERA5_2<- brick(x = 'dataMA/20012009ERA5wateriso-004.nc',
                   varname="mtpr")
mtprERA5_3<- brick(x = 'dataMA/20102019ERA5wateriso-003.nc',
                   varname="mtpr")
...
sltERA5_1<- brick(x = 'dataMA/19892000ERA5wateriso-002.nc',
                   varname="slt")
sltERA5_2<- brick(x = 'dataMA/20012009ERA5wateriso-004.nc',
                   varname="slt")
sltERA5_3<- brick(x = 'dataMA/20102019ERA5wateriso-003.nc',
                   varname="slt")
